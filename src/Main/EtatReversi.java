...
public class EtatReversi extends EtatJeu {
	...
	/**
	 * Constructeur pour l'Ã©tat initial
	 * @param joueur
	 * 				Joueur actuel
	 */
	...
	/**
	 * Mï¿½thode d'affichage de l'ï¿½tat
	 */
	...
	/**
	 * 
	 * @param e permet d'ajouter un etat successeur Ã  la liste d'etat successeur
	 */
	...
	//on ne peut aller Ã  droite que si j>0
